...
urlpatterns = patterns('',
    ...
    url(r'^api/events_statistics_services/$', 'CesMonitorApi.views.events_statistics_services'),
    url(r'^api/events_statistics_services_host/$', 'CesMonitorApi.views.events_statistics_service_host'),
