    ...
    */
    ...
    var initDomEvent = function() {
        ...
        $('#divAlertListIcon').click(function(event) {
            ...
            $('#divWindowAlertListTitle').css('background-color',_GLOBE_DATA('colorMainGreen')).css('color','white').css('border-color','rgb(42,180,153)');
...
$('#divAppMonitorIcon').click(function(event) {
    $('.div-Window-Title').css('background-color','rgb(240,240,240)').css('color','rgb(180,180,180)').css('border-color','rgb(180,180,180)');;
    $('#divWindowAppMonitorTitle').css('background-color',_GLOBE_DATA('colorMainGreen')).css('color','white').css('border-color','rgb(42,180,153)');;
    var tempArray = [];
    for (var tempItem in _GLOBE_DATA('windowArray')) {
...
$('#divEquipmentInfoIcon').click(function(event) {
    $('.div-Window-Title').css('background-color','rgb(240,240,240)').css('color','rgb(180,180,180)').css('border-color','rgb(180,180,180)');
    $('#divWindowEquipmentTitle').css('background-color',_GLOBE_DATA('colorMainGreen')).css('color','white').css('border-color','rgb(42,180,153)');
    var tempArray = [];
    for (var tempItem in _GLOBE_DATA('windowArray')) {
...
var init = function() {
    ...
    $.ajax({
        type: 'get',
        url: "http://172.17.10.61:8000/api/classifications/",
        dataType: 'json',
        cache: false,
    ...
    var equipmentAlertChart = new Highcharts.Chart(equipmentAlertChartObject);
    /*
...
var equipmentAlertChartObject = {
    ...
    series: [{
        name: '严重',
        data: [8, 1, 4, 7, 0, 2, 2],
        color:_GLOBE_DATA('colorAlertLevel4')
    }, {
        name: '普通',
        data: [5, 9, 2, 3, 2, 6, 2],
        color:_GLOBE_DATA('colorAlertLevel3')

    }, {
        name: '警告',
        data: [1, 5, 5, 7, 3, 2, 8],
        color:_GLOBE_DATA('colorAlertLevel2')
    }, {
        name: '消息',
        data: [0, 8, 2, 4, 0, 1, 5],
        color:_GLOBE_DATA('colorAlertLevel1')
